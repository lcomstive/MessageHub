...
module.exports = class PlatformMessenger extends PlatformBase
{
	...
	{
		if(this._options.debug)
			console.log(`[MSG_HUB][MESSENGER] Sending facebook message '${hubMsg.message}' to '${hubMsg.user}'`)
		console.log(`ACCESS_TOKEN: '${this._options.token}'`)
		request({
